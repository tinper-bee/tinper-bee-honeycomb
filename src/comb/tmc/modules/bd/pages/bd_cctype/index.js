...
import CCTypeForm from '../../containers/CCTypeForm';
...
export default class CCType extends Component {
	constructor() {
		super();
		this.state = {
			breads: [],
			...
			columns: [
				...
				},
				{
					...
					render: (text, record, index) => {
						let preset = record && record.preset;
						return (
							<div>
								{!preset && (
									<Icon
	...
	getTableData = (pageIndex, pageSize, keyWords = '') => {
		...
		Ajax({
			...
			error: function(res) {
				toast({ content: '后台报错,请联系管理员\n' + res.message.message, color: 'danger' });
			}
		});
	};
		...
		return (
			<div className="bd-wraps">
				<Breadcrumb>
					...
					<Breadcrumb.Item active>授信类别</Breadcrumb.Item>
				</Breadcrumb>
				<div className="bd-header">
					<div className="bd-title-1">授信类别</div>
