...
### 2.3 结息日页面新增保存接口
- 请求地址：`/bd_bankaccbas/interestdayadd`
- 请求方式：`POST`
- 请求参数：

预留银行账户档案中，参照新增保存结息日接口


### 2.4 结息日页面删除接口
- 请求地址：`/interestday/delete`
- 请求方式：`POST`
- 请求参数：
